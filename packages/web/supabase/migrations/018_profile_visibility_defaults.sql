...
ALTER TABLE profiles
  ADD COLUMN IF NOT EXISTS default_is_public boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS default_visible_to_followers boolean NOT NULL DEFAULT false,
  ADD COLUMN IF NOT EXISTS default_visible_to_following boolean NOT NULL DEFAULT false;
...
ALTER TABLE lists
  ADD COLUMN IF NOT EXISTS custom_visibility boolean NOT NULL DEFAULT false;
