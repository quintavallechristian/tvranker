...
import { Television, Star } from "@phosphor-icons/react";
import type { LastAddedShow } from "@/app/[locale]/(app)/home/actions";
import { Link } from "@/i18n/navigation";
import { useTranslations } from "next-intl";

export function LastShowWidget({ item }: { item: LastAddedShow | null }) {
