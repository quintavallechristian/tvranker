...
function ListDetailClient({ list, isOwner, isLoggedIn, existingTmdbIds, ratingLabels, allTags = [], showTagsMap: initialShowTagsMap = {}, hasMore: initialHasMore, listId, userLists = [] }) {
    ...
    const [quickAddShowId, setQuickAddShowId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const handleQuickAddToList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListDetailClient.useCallback[handleQuickAddToList]": async (targetListId, show)=>{
            const showKey = show.id;
            try {
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f5b$locale$5d2f28$app$292f$lists$2f$data$3a$d09a9f__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["addShowToMyList"])(targetListId, {
                    id: show.id,
                ...
                const targetName = userLists.find({
                    "ListDetailClient.useCallback[handleQuickAddToList]": (l)=>l.id === targetListId
                }["ListDetailClient.useCallback[handleQuickAddToList]"])?.name ?? "";
                if (result.alreadyExists) {
                    setQuickAddFeedback({
                        "ListDetailClient.useCallback[handleQuickAddToList]": (prev)=>({
                                ...prev,
                                [showKey]: t("alreadyInList")
                            })
                    }["ListDetailClient.useCallback[handleQuickAddToList]"]);
                } else {
                    setQuickAddFeedback({
                        "ListDetailClient.useCallback[handleQuickAddToList]": (prev)=>({
                                ...prev,
            ...
            }["ListDetailClient.useCallback[handleQuickAddToList]"], 2000);
        }
    }["ListDetailClient.useCallback[handleQuickAddToList]"], [
        userLists,
        t
    ...
    const handleDuplicateList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ListDetailClient.useCallback[handleDuplicateList]": async ()=>{
            setIsDuplicating(true);
            try {
                const newName = t("copyOf", {
                    name: list.name
                });
                const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f5b$locale$5d2f28$app$292f$lists$2f$data$3a$da2d42__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["duplicateList"])(list.id, newName);
                i18nRouter.push(`/lists/${result.listId}`);
            } catch  {
                setIsDuplicating(false);
            }
        }
    }["ListDetailClient.useCallback[handleDuplicateList]"], [
        list.id,
        list.name,
        t,
        i18nRouter
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    !isOwner && isLoggedIn && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: group.items.map((item)=>{
                                            ...
                                            return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(ShowRowObserver, {
                                                ...
                                                children: [
                                                    ...
                                                    quickAddShowId === item.shows.id && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                className: "space-y-1",
                                                                children: userLists.map((ul)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s1(ListDetailClient, "wf+irE6RoU33+NlzbvVZAmZE1wQ=", false, function() {
    return [
...
//# sourceMappingURL=src_5bf79123._.js.map