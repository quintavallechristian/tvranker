...
"[project]/packages/web/src/app/[locale]/(app)/users/[username]/user-list-client.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$phosphor$2d$icons$2f$react$2f$dist$2f$csr$2f$Funnel$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@phosphor-icons/react/dist/csr/Funnel.es.js [app-client] (ecmascript)");
...
;
;
function UserListClient({ listId, initialItems, initialHasMore, ratingLabels, isLoggedIn, viewerItems: initialViewerItems }) {
    _s();
    ...
    const [showCommonOnly, setShowCommonOnly] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const viewerRatingMap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserListClient.useMemo[viewerRatingMap]": ()=>{
            const map = new Map();
    ...
    const inMyList = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserListClient.useCallback[inMyList]": (showId)=>viewerRatingMap.has(showId) || addedShowIds.has(showId)
    }["UserListClient.useCallback[inMyList]"], [
        viewerRatingMap,
        addedShowIds
    ]);
    const getViewerRating = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UserListClient.useCallback[getViewerRating]": (showId)=>{
            if (addedShowIds.has(showId) && !viewerRatingMap.has(showId)) return undefined;
            return viewerRatingMap.get(showId);
        }
    }["UserListClient.useCallback[getViewerRating]"], [
        viewerRatingMap,
        addedShowIds
    ]);
    ...
    const ratingGroups = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserListClient.useMemo[ratingGroups]": ()=>{
            const filtered = showCommonOnly ? items.filter({
                "UserListClient.useMemo[ratingGroups]": (item)=>inMyList(item.shows.id)
            }["UserListClient.useMemo[ratingGroups]"]) : items;
            const sorted = [
                ...filtered
            ].sort({
    ...
    const commonCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "UserListClient.useMemo[commonCount]": ()=>items.filter({
                "UserListClient.useMemo[commonCount]": (item)=>inMyList(item.shows.id)
            }["UserListClient.useMemo[commonCount]"]).length
    }["UserListClient.useMemo[commonCount]"], [
        items,
        inMyList
    ]);
    // Infinite scroll
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-6",
        children: [
            isLoggedIn && commonCount > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "flex items-center gap-2",
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                    onClick: ()=>setShowCommonOnly((v)=>!v),
                    className: `flex items-center gap-1.5 rounded-full border px-3 py-1 text-xs font-medium transition-colors ${showCommonOnly ? "border-accent bg-accent-muted text-accent" : "border-border text-text-muted hover:border-border-hover hover:text-text-secondary"}`,
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$phosphor$2d$icons$2f$react$2f$dist$2f$csr$2f$Funnel$2e$es$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Funnel"], {
                            size: 12,
                            weight: showCommonOnly ? "fill" : "regular"
                        }, void 0, false, {
                            fileName: "[project]/packages/web/src/app/[locale]/(app)/users/[username]/user-list-client.tsx",
                            lineNumber: 185,
                            columnNumber: 13
                        }, this),
                        "In comune (",
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: group.items.map((item)=>{
                                ...
                                const posterUrl = (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$shared$2f$src$2f$lib$2f$tmdb$2f$types$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getPosterUrl"])(item.shows.poster_path, "w92");
                                ...
                                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        isLoggedIn && (alreadyAdded ? viewerRating != null ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            showCommonOnly && ratingGroups.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                className: "text-sm text-text-muted",
                children: "Nessuna serie in comune."
            }, void 0, false, {
                fileName: "[project]/packages/web/src/app/[locale]/(app)/users/[username]/user-list-client.tsx",
                lineNumber: 291,
                columnNumber: 9
...
_s(UserListClient, "hJ6brESr0A7Xef5FwyxzFe9MBQM=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useTransition"]
    ];
});
...
//# sourceMappingURL=packages_a8ebd069._.js.map