...
;
;
function ShowCard({ title, posterPath, rating, position, onRatingChange, compact = false, showId }) {
...
;
;
function ShowRow({ id, title, posterPath, rating, position, onRatingChange, onRemove, readOnly = false, showId }) {
    _s();
        ...
        "ListDetailClient.useCallback[handleDragEnd]": (event)=>{
            ...
            startTransition({
                "ListDetailClient.useCallback[handleDragEnd]": async ()=>{
                    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f5b$locale$5d2f28$app$292f$lists$2f$data$3a$c631a1__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["reorderListItems"])(list.id, newItems.map({
...
//# sourceMappingURL=src_c3ee0474._.js.map